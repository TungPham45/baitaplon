            ...
            <aside class="user-sidebar">
                ...
                <div class="user-info-details">
                    ...
                    <p><i class="fas fa-map-marker-alt"></i> Địa chỉ:
                        <b><?php echo !empty($user['diachi']) ? $user['diachi'] : 'Chưa cung cấp'; ?></b></p>
                </div>
            </aside>
                                ...
                                <div class="product-card" style="opacity: 0.8;">
                                    <div class="p-img">
                                        <img src="/baitaplon/public/images/products/default-product.jpg"
                                            onerror="this.src='https://via.placeholder.com/300/eee/ccc?text=No+Image'">
                                        <div
                                            style="position: absolute; top: 0; left: 0; background: rgba(0,0,0,0.5); color: #fff; padding: 2px 8px; font-size: 0.7rem;">
                                            ĐÃ BÁN</div>
                                    </div>
                                    <div class="p-info">
                                        <h4><?php echo $p['title']; ?></h4>
