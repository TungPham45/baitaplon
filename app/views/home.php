...
<head>
    ...
    <style>
        ...
        .dropdown-item-parent:hover>.dropdown-item {
            background-color: #f8f9fa;
        }
        ...
        <div class="container">
            ...
            <div class="d-flex align-items-center gap-3">
                <?php if (isset($data['isLoggedIn']) && $data['isLoggedIn']): ?>
                    <button class="btn btn-warning fw-bold text-dark btn-sm" data-bs-toggle="modal"
                        data-bs-target="#postModal"><i class="bi bi-plus-lg"></i> Đăng tin</button>
                    <a href="/baitaplon/Chat/index/0/<?php echo $currentUserId; ?>" class="text-secondary fs-5"><i
                            class="bi bi-chat-dots-fill"></i></a>
                    <div class="dropdown">
                        <a href="#" class="text-secondary fs-5" data-bs-toggle="dropdown"><i
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow">
                            ...
                            <li><a class="dropdown-item"
                                    href="/baitaplon/User/Profile/<?php echo urlencode($currentUserId); ?>">Trang cá
                                    nhân</a></li>
            ...
            <div class="col-12">
                ...
                if (isset($data["page"]) && $data["page"]) {
                    ...
                    if (file_exists($pageFile))
                        ...
                        echo '<div class="alert alert-danger">Không tìm thấy file: ' . htmlspecialchars($data["page"]) . '</div>';
                } else
                    echo '<div class="alert alert-warning">Chưa chọn trang!</div>';
                ?>
            </div>
        </div>
    </div>
                ...
                <form id="postForm" enctype="multipart/form-data">
                    <input type="hidden" name="id_user_posted" value="<?php echo isset($currentUserId) ? $currentUserId : ''; ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="text-danger small mt-1" id="err-images" style="display:none">Vui lòng chọn ít
                                nhất 1 ảnh.</div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select id="catLevel1" name="catLevel1" class="form-select">
                                    <option value="">-- Chọn danh mục --</option>
                                </select>
                                <div class="text-danger small" id="err-catLevel1" style="display:none">Chọn danh mục.
                                </div>
                            </div>
                            <div class="col-md-6 mb-3" id="group-catLevel2" style="display:none;">
                                <label class="form-label fw-bold">Loại sản phẩm <span
                                        class="text-danger">*</span></label>
                                <select id="catLevel2" name="catLevel2" class="form-select">
                                    <option value="">-- Chọn loại --</option>
                                </select>
                                <div class="text-danger small" id="err-catLevel2" style="display:none">Chọn loại sản
                                    phẩm.</div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="text-danger small" id="err-description" style="display:none">Mô tả quá ngắn.
                            </div>
                        </div>
                        ...
                        <div class="mb-3" style="position: relative;">
                            ...
                            <div class="text-danger small" id="err-address" style="display:none">Vui lòng nhập địa chỉ.
                            </div>
                        </div>
